...
function github_plugin_updater_test_init() {
	...
	if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
		...
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/kalingga/WordPress-GitHub-Plugin-Updater',
			'raw_url' => 'https://raw.github.com/kalingga/WordPress-GitHub-Plugin-Updater/master',
			'github_url' => 'https://github.com/kalingga/WordPress-GitHub-Plugin-Updater',
			'zip_url' => 'https://github.com/kalingga/WordPress-GitHub-Plugin-Updater/archive/master.zip',
			'sslverify' => true,
			'requires' => '3.0',
			'tested' => '3.3',
			'readme' => 'README.md',
